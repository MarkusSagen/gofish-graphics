      ...
      "/api/": [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "connect", link: "/api/operators/connect" },
            { text: "frame", link: "/api/operators/frame" },
            { text: "arrow", link: "/api/operators/arrow" },
            { text: "enclose", link: "/api/operators/enclose" },
            { text: "wrap", link: "/api/operators/wrap" },
            { text: "position", link: "/api/operators/position" },
        ...
        },
        {
          ...
          items: [
            ...
            { text: "bipolar", link: "/api/coords/bipolar" },
            { text: "arcLengthPolar", link: "/api/coords/arc-length-polar" },
            { text: "wavy", link: "/api/coords/wavy" },
          ],
        },
      ],
      "/": [
